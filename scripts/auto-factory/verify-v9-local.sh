...
node --check scripts/auto-factory/v9-json-parser.mjs
node --check scripts/auto-factory/v9-ai-provider-router.mjs
...
node scripts/auto-factory/test-v9-json-parser.mjs
